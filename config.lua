print("^0======================================================================^7")
print("^0[^4Author^0] ^7:^0 ^0Pour Lithium.CW By cheglalw83^7")
print("^0[^3Version^0] ^7:^0 ^01.0^7")
print("^0[^2Download^0] ^7:^0 ^5https://github.com/Cheglalw83/Lithium_SodaMachine.git")
print("^0======================================================================^7")
...
Config.Zones = {
	...
	Sprunk = {
		...
		Pos = {
			...
			--{x = 1702.28,	y = 4922.53,  z = 42.06}, SIGNE HORS SERVICE
			{x = 1587.63,	y = 6449.8,   z = 25.32},
			{x = 1486.87,	y = 1134.89,  z = 114.33},
			--{x = 1162.06,	y = -319.56,  z = 69.21}, SIGNE HORS SERVICE
			...
			--{x = -1824.25,	y = 795.41,   z = 138.14},SIGNE HORS SERVICE
